...
public class AdminGoodsControllerImpl extends BaseController implements AdminGoodsController {
    ...
    public ResponseEntity addNewGoods(MultipartHttpServletRequest multipartHttpServletRequest, HttpServletResponse response) throws Exception{
        ...
        List<ImageFileVO> imageFileList = upload(multipartHttpServletRequest);
        ...
        try {
            ...
            message += "location.href = '"+ multipartHttpServletRequest.getContextPath() + "/admin/goods/addNewGoodsForm.do';";
            message += ("</script>");
        } catch (Exception e) {
            if (imageFileList != null && imageFileList.size() != 0) {
                for (ImageFileVO imageFileVO : imageFileList) {
            ...
            message += "location.href = '"+ multipartHttpServletRequest.getContextPath() + "/admin/goods/addNewGoodsForm.do';";            message += ("</script>");
            e.printStackTrace();
        }
    ...
    public void modifyGoodsImageInfo(MultipartHttpServletRequest multipartHttpServletRequest, HttpServletResponse response) throws Exception{
        ...
        int image_id = 0;
        try{
            imageFileList = upload(multipartHttpServletRequest);
            if (imageFileList != null && imageFileList.size() != 0) {
                for (ImageFileVO imageFileVO : imageFileList){
                ...
                for (ImageFileVO imageFileVO : imageFileList){
                    ...
                    FileUtils.moveFileToDirectory(srcFile, desDir, true);       // 파일 생성
                }
            }
        }catch (Exception e) {
            if (imageFileList != null && imageFileList.size() != 0){
