...
function fn_order_each_goods(goods_id,goods_title,goods_sales_price,fileName){
	var _isLogOn=document.getElementById("isLogOn");	// 로그인 확인
	var isLogOn=_isLogOn.value;							// 유저 정보
	
	 if(isLogOn=="false" || isLogOn=='' ){				// 비로그인 주문 시
...
<%--				게시판기능 있으면? --%>
	...
	<div id="layer" style="visibility: hidden">
		...
		<div id="popup">
			...
			</a> <br /> <span id="contents">장바구니에 담았습니다.</span><br>
