...
function check_pw(){     // 비밀번호 확인 함수

	var pw = document.getElementById('pw').value;
	// var SC = ["!","@","#","$","%"];  특수문자 사용할 경우 활성화
	// var check_SC = 0;
	...
	if(document.getElementById('pw').value !='' && document.getElementById('pw2').value!=''){
		if(document.getElementById('pw').value==document.getElementById('pw2').value){
			...
			document.getElementById('check').style.fontSize='13';
		}
		else{
		...
		<table>
			<tbody>
				<tr class="dot_line">
					...
					<td>
					  <input type="text" name="_member_id"  id="_member_id"  size="20" required/>
...
<%--				8~16 글자--%>
				...
				<tr class="dot_line">
					...
					<td><input id="pw2" type="password" size="20" onchange="check_pw()" /> &nbsp; <span id="check"/> </td>
				</tr>
				<tr class="dot_line">
				...
				<tr class="dot_line">
					...
					<td><input type="radio" name="member_gender" value="102" />
						남<span style="padding-left:60px"></span>
						 <input type="radio" name="member_gender" value="101" checked />여
					</td>
				</tr>
				<tr class="dot_line">
...
<%--						<input type="radio"  name="member_birth_gn" value="1" />음력--%>
				...
				<tr class="dot_line">
					...
					<td><input size="10px"   type="text" name="email1" required/> @ <input  size="10px"  type="text"name="email2" />
